var SongsList = require("./models").SongsList;

var PlayListView = exports.PlayListView = Backbone.View.extend({
    el:$('#playing_list'),
    ...
    addOne:function(song){
        if(song.get('fileName')){
            ...
            var view=new SongMiniView({model:song});
            song.view=view;
...
var SongMiniView=Backbone.View.extend({
    className:'song-data',
    tplId:'song_mini_tpl',
    events:{
