var ArtistsList = require("./models").ArtistsList;
var PlayLists = require("./models").PlayLists;
var AlbumList = require("./models").AlbumList;

var LibraryMenu = exports.LibraryMenu = Backbone.View.extend({
    el:$('#library_menu'),
    ...
    initialize:function(){
        ...
        this.artists.fetch({success:function(o){console.log("xxx");},error:function(o){console.log("xxx1");}});
    ...
    addAlbum:function(album){
        if(!this.albums.isExist(album)){
            ...
            var view=new AlbumMenuView({model:album});
    ...
    addArtist:function(artist){
        ...
        if(artist.get('name') && !artist.get('isDeleted')){
            ...
            var view=new ArtistMenuView({model:artist});
            this.artistsContent.append(view.render().el);
        }
    },
    addPlayList:function(playList){
        var view=new PlayListMenuView({model:playList});
        this.playListsContent.append(view.render().el);
    },
    addSoundCloudTrack:function(soundCloudTrack){
        var view=new SoundCloudTrackMenuView({model:soundCloudTrack});
...
var AlbumMenuView=Backbone.View.extend({
    className:'lib-item-data box',
    tagName:'article',
    tplId:'album_lib_tpl',
    events:{
...
var SoundCloudTrackMenuView=Backbone.View.extend({
    className:'lib-item-data box',
    tagName:'article',
