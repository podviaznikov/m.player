...
_.mixin({contains:function(a,b){return a.toUpperCase().indexOf(b.toUpperCase())!==-1},firstHashValue:function(){return window.location.hash.substring(1).split("&")[0].split("=")[1]},secondHashKey:function(){return window.location.hash.substring(1).split("&")[1].split("=")[0]}});
...
a})},comparator:function(a){return a.get("name")}}),SoundCloudTrack=Backbone.Model.extend({}),SoundCloudTrackList=Backbone.Collection.extend({model:SoundCloudTrack});
...
this.playLists.bind("add",this.addPlayList);this.playLists.bind("reset",this.addPlayLists);this.soundCloudTracks.bind("add",this.addSoundCloudTrack);this.soundCloudTracks.bind("reset",this.addSoundCloudTracks);this.artists.fetch();this.playLists.fetch();this.soundCloudTracks.url="/sc/tracks?access_token="+AppController.settings.getScAccessToken();console.log(this.soundCloudTracks.url);this.soundCloudTracks.fetch({success:function(a,b){console.log(a,b)},error:function(a,b){console.log("er",a,b)}})},
...
events:{click:"playTrack"},initialize:function(){_.bindAll(this,"render","hide","show","playTrack");this.model.view=this},render:function(){var a=_.template(this.tpl,{name:this.model.get("name")});$(this.el).html(a);return this},playTrack:function(){AppController.playerCtrl.play(this.model.get("url"))},hide:function(){this.$(this.el).hide()},show:function(){this.$(this.el).show()}})});
