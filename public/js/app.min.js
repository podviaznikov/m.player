...
Porridge.Collection.extend({model:Artist,forName:function(a){return this.find(function(b){return b.get("name")===a})},comparator:function(a){return a.get("name")}}),Album=Backbone.Model.extend({findImage:function(){var a=this;dataService.getAlbumImage(this.get("artist"),this.get("name"),function(b){a.set({image:b})})}}),AlbumList=Backbone.Collection.extend({model:Album,isExist:function(a){return this.forModel(a)!==void 0},forModel:function(a){return this.find(function(b){return b.get("name")===a.get("name")})},
