...
e.val(f);var a=b.get("artist"),c=AppController.libraryMenu.artists.forName(a);c?(c.set({isDeleted:!1}),a=c.get("songsCount")||0,c.set({songsCount:a+1}),c.songs.add(b,{silent:!0}),c.save(),c.change(),d(null)):(c=new Artist({name:a}),c.findImage(function(){AppController.libraryMenu.artists.add(c);d(null)}))}},b.get("fileName"))})})},showHelp:function(){this.isRegularMode=!1;this.el.removeClass("fullscreen");this.helpScreen.removeClass("hidden");this.mainScreen.addClass("hidden");AppController.visualizationView.hide()},
hideHelp:function(){this.isRegularMode=!0;this.mainScreen.removeClass("hidden");this.helpScreen.addClass("hidden")},showFullScreen:function(){this.hideHelp();this.mainScreen.addClass("hidden");this.el.addClass("fullscreen");AppController.visualizationView.show()},hideFullScreen:function(){this.el.removeClass("fullscreen");this.isRegularMode?this.mainScreen.removeClass("hidden"):this.helpScreen.removeClass("hidden");AppController.visualizationView.hide()},keyPressed:function(a){var a=a.keyCode,b;AppController.playlistView&&
...
this.render()},hide:function(){this.el.hide()},render:function(){var a=this,b=AppController.playlistView.currentSong();b&&dataService.getAlbumPoster(b.get("artist"),b.get("album"),function(b){a.renderTpl({image:b})});return this}})});
