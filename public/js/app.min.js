...
dbVersion:"1",stores:[Song.definition,Artist.definition,PlayList.definition]},function(){"1"!==AppController.settings.getDbVersion()&&(fs.io.readFilesFromRootDirectory(function(a,b){a||(console.log("Files",b),AppController.appView.handleFileSelect(b,!0))}),AppController.settings.saveDbVersion("1"));console.log("Initialized views and social services");AppController.playlistView=new ui.PlayListView;AppController.libraryMenu=new ui.LibraryMenu;AppController.soundcloudConnect();AppController.facebookConnect();
