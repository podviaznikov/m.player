...
void 0},forModel:function(a){return this.find(function(b){return b.get("name")===a.get("name")})},forName:function(a){return this.find(function(b){return b.get("name")===a})},comparator:function(a){return a.get("name")}}),PlayList=Porridge.Model.extend({defaults:{songs:[]},findSongs:function(){var a=this.get("songs")||[];return new SongsList(a)},findImage:function(a){var b=this.findSongs();b.length>0?(b=b.first(),dataService.getAlbumImage(b.get("artist"),b.get("album"),a)):a("css/images/no_picture.png")},
findGenres:function(){return this.findSongs().listOfGenres()}},{definition:{name:"playlist",key:"id"}}),PlayLists=Porridge.Collection.extend({model:PlayList,forName:function(a){return this.find(function(b){return b.get("name")===a})},comparator:function(a){return a.get("name")}}),SoundCloudTrack=Backbone.Model.extend({}),SoundCloudTrackList=Backbone.Collection.extend({model:SoundCloudTrack,url:function(){return"/sc/tracks?access_token="+AppController.settings.getScAccessToken()}});
...
tplId:"visualization_tpl",show:function(){this.el.show();this.render()},hide:function(){this.el.hide()},render:function(){var a=this,b=AppController.playlistView.currentSong();b&&dataService.getAlbumPoster(b.get("artist"),b.get("album"),function(b){a.renderTpl({image:b})});return this}})});
