...
dbVersion:"1",stores:[Song.definition,Artist.definition,PlayList.definition]},function(){"1"!==AppController.settings.getDbVersion()&&(fs.io.readFilesFromRootDirectory(function(a,b){a||(console.log("Files",b),AppController.appView.handleFileSelect(b,!1))}),AppController.settings.saveDbVersion("1"));console.log("Initialized views and social services");AppController.playlistView=new ui.PlayListView;AppController.libraryMenu=new ui.LibraryMenu;AppController.soundcloudConnect();AppController.facebookConnect();
...
function(b){b.name&&(AppController.settings.saveFbAccessToken(a),AppController.settings.saveFbUser(b.name),AppController.playerCtrl.fbLogin(b.name))}))},facebookConnect:function(){AppController.settings.isFbLogined()&&AppController.playerCtrl.fbLogin(AppController.settings.getFbUser())},soundcloudConnect:function(){AppController.settings.isScLogined()&&(AppController.playerCtrl.scLogin(AppController.settings.getScUser()),AppController.libraryMenu.showSoundCloudMenu())},lastfmConnect:function(){AppController.settings.isLastFmLogined()?
