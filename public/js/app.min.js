...
AudioEl.newAudio("player_ctrl");this.audioEl.on("updated",this.updateAudioProgress);this.audioEl.on("finished",this.songFinished);this.audioEl.volume=AppController.settings.getVolume();this.volumeSlider.attr("value",AppController.settings.getVolume())},scLogin:function(a){this.scLoginBtn.hide();this.scControlPanel.removeClass("unlogined");this.scControlPanel.addClass("logined");this.scUsername.html(a)},scLogout:function(){this.scLoginBtn.show();this.scControlPanel.removeClass("logined");this.scControlPanel.addClass("unlogined");
...
dataService.scrobble(a.get("title"),a.get("artist"),b),this.next()}})});
